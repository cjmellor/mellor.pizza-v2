    ...
    <main class="relative container my-20 space-y-8 px-3.5 pt-40 sm:pt-0 md:px-24">
        ...
        <section>
            ...
            <p class="text-sm leading-relaxed text-gray-700 md:text-base dark:text-gray-300">
                Full-stack developer with 5 years of commercial experience creating SaaS platforms and eCommerce solutions. My expertise lies in the Laravel ecosystem, though I readily adapt to other modern development stacks when needed. I
                focus on writing clean, maintainable code backed by solid testing practices. My approach combines practical solutions with modern development techniques to deliver robust, well-structured applications.
            </p>
        </section>
        ...
        <section>
            ...
            <div class="grid gap-6 md:grid-cols-3 print:grid-cols-1">
                <!-- Primary Stack -->
                <div class="bg-pizza/5 shadow-pizza/50 ring-pizza/20 dark:bg-dark dark:ring-dark-line rounded-lg p-6 ring-1 print:bg-transparent print:p-0 print:px-4 print:ring-0">
        ...
        <section class="space-y-8 sm:space-y-0 print:space-y-6">
            ...
            <div class="dark:bg-dark rounded-lg bg-white md:p-6 print:md:p-2">
                ...
                <ul class="list-inside list-disc space-y-2 text-sm text-gray-700 md:text-base dark:text-gray-300">
                    <li>Spearheaded system modernisation by resolving critical bugs and implementing new features while successfully upgrading the Laravel framework version</li>
                    <li>Core member of a three-person team rebuilding the company's flagship software from the ground up using the TALL stack (Tailwind, Alpine.js, Laravel, Livewire)</li>
                    <li>Actively contributed to code quality through regular peer review processes and pull request assessments</li>
                    <li>
                        Successfully delivered a complete mobile solution, encompassing both a cross-platform application (built with Vue.js and Ionic Framework) and its supporting Laravel API using Sanctum authentication. Notable
                        achievement in independently learning multiple new technologies and delivering both applications to production within a 6-month timeline
                    </li>
                    <li>Established and configured Laravel Vapor infrastructure, including implementation of dynamic PR environments for enhanced testing capabilities</li>
            ...
            <div class="dark:bg-dark rounded-lg bg-white md:p-6 print:md:p-2">
                ...
                <ul class="list-inside list-disc space-y-2 text-sm text-gray-700 md:text-base dark:text-gray-300">
                    <li>Led multiple client projects in an agency environment, focusing on modernising legacy applications using Laravel and modern PHP practices</li>
                    <li>Architected and implemented new features using Inertia.js, demonstrating ability to adapt to client-specific technology requirements</li>
                    <li>Championed test-driven development practices, significantly improving code reliability and maintenance</li>
                    <li>Collaborated directly with clients through daily stand-ups to gather requirements and demonstrate feature implementations</li>
            ...
            <div class="dark:bg-dark rounded-lg bg-white md:p-6 print:md:p-2">
                ...
                <ul class="list-inside list-disc space-y-2 text-sm text-gray-700 md:text-base dark:text-gray-300">
                    <li>Played a key role in developing and enhancing a Laravel-based eCommerce platform for a major UK blinds and curtains retailer</li>
            ...
            <div class="dark:bg-dark rounded-lg bg-white md:p-6 print:md:p-2">
                ...
                <ul class="list-inside list-disc space-y-2 text-sm text-gray-700 md:text-base dark:text-gray-300">
                    <li>Spearheaded complete rebuild of company website using Laravel, Vue.js, and Tailwind CSS, delivering a modern, responsive platform</li>
        ...
        <section>
            ...
            <div class="dark:bg-dark rounded-lg bg-white md:p-6 print:md:p-3">
                <p class="text-sm leading-relaxed text-gray-700 md:text-base dark:text-gray-300">
                    I create Laravel packages that solve problems I've encountered in my own development work. When existing packages don't meet my standards or specific needs, I build my own solutions. One of my packages has gained over
                    500 stars on GitHub and continues to receive recognition on X. I maintain an active presence in the Laravel ecosystem, keeping ahead of framework developments and emerging tools, which helps me bring fresh perspectives
                    to my projects.
                </p>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="dark:bg-dark rounded-lg bg-white md:p-6 print:md:p-3">
                <p class="text-sm leading-relaxed text-gray-700 md:text-base dark:text-gray-300">
                    Beyond development, I'm passionate about solo travel and experiencing different cultures. A long-time wrestling fan, I balance this with regularly attending live music events and festivals. I maintain a keen interest in
                    AI technologies, exploring their potential in modern development practices.
                </p>
            </div>
        </section>
    </main>
