...
>
    ...
    <main class="relative container my-20 space-y-8 px-3.5 pt-40 sm:pt-0 md:px-24">
        ...
        <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Below is the private client work I have done. I am new to this so it is a little bare at the moment.
        </p>
        <ul
            ...
            @foreach (\App\Models\Project::get() as $project)
                <li class="group relative flex flex-col items-start">
                    ...
                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                        <div
                            class="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-900/50"
                        ></div>
                    ...
                    @if ($project->url)
                        <p
                            class="group-hover:text-pizza dark:group-hover:text-pizza-dark relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition dark:text-zinc-300"
                        >
                            <a
